...
public class AstigFitterTest<T extends IntegerType<T> & NativeType<T> & RealType<T>, F extends Frame<T>> {
	...
	private void setUp() {
		...
		final SaveLocalizations saver = new SaveLocalizations(new File("/media/backup/ownCloud/set1.csv"));
