...
import org.micromanager.AstigPlugin.tools.LogHistogramDataset;
import org.micromanager.AstigPlugin.tools.NumericHistogram;
import org.micromanager.AstigPlugin.tools.XYTextSimpleAnnotation;
...
class HistogramPanel extends JPanel
{
	...
	private void initGUI()
	{
		...
		try
		{
			...
			final ComboBoxModel jComboBoxFeatureModel = new DefaultComboBoxModel( table.getNames().keySet().toArray( new String[] {} ) );
