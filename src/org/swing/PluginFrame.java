...
public class PluginFrame extends javax.swing.JFrame {
    ...
    private void jButton_loadcalActionPerformed(java.awt.event.ActionEvent evt) {                                                
        ...
        JFileChooser jf = new JFileChooser(System.getProperty("user.home")+"/ownCloud/storm");
        FileNameExtensionFilter filter = new FileNameExtensionFilter("Csv files", "csv");
 ...
 // fit method 
    ...
    private static final long serialVersionUID = -6586536773494950350L;
	
    // calibration
    private String cal_filePath;
    private ImagePlus cal_im;
	private int zstep;
    private  Roi roi;
    private Calibrator cal;
    private StackWindow st;
    private int rangeMin, rangeMax;
    private boolean stack_fitted=false;
    private boolean curve_fitted=false;
    static private final int default_step = 10;
    static private final int default_rmin = 0;
    static private final int default_rmax = 200;
